...
# Default TinyLlama endpoint - you can change this
TINYLLAMA_ENDPOINT_URL = os.getenv("TINYLLAMA_ENDPOINT_URL", "https://your-tinyllama-endpoint.ngrok-free.app/generate")

class TinyLlamaEvaluator:
    def __init__(self, endpoint_url=None):
        self.endpoint_url = endpoint_url or TINYLLAMA_ENDPOINT_URL
        self.test_results = {}
    ...
    def test_instruction_tracking(self):
        """Test how well TinyLlama understands roleplaying and direct speech."""
...
Respond as Thorin:"""
    ...
    def test_prompt_injection(self):
        """Test if TinyLlama copies and pastes the "You are..." part."""
...
Answer:"""
    ...
    def test_roleplay_naturalness(self):
        """Test if TinyLlama acts like the character or spews information."""
...
Respond as Kael Vire:"""
    ...
    def test_rag_compatibility(self):
        """Test if TinyLlama responds logically to external context."""
...
Respond as Kael Vire:"""
    ...
    def test_dialog_continuation_issue(self):
        """Test the specific dialog continuation issue mentioned by user."""
...
Respond as Kael Vire:"""
    ...
    def generate_report(self):
        ...
        print("\n" + "="*80)
        print("TINYLLAMA MODEL EVALUATION REPORT")
        print("="*80)
...
def main():
    print("Starting TinyLlama Model Evaluation...")
    print(f"Using endpoint: {TINYLLAMA_ENDPOINT_URL}")
    
    # Allow user to specify endpoint
    custom_endpoint = input("Enter TinyLlama endpoint URL (or press Enter to use default): ").strip()
    if custom_endpoint:
        evaluator = TinyLlamaEvaluator(custom_endpoint)
    else:
        evaluator = TinyLlamaEvaluator()
