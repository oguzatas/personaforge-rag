...
class Phi2Evaluator:
    ...
    def test_instruction_tracking(self):
        """Test how well Phi-2 understands roleplaying and direct speech."""
...
Respond as Thorin:"""
    ...
    def test_prompt_injection(self):
        """Test if Phi-2 copies and pastes the "You are..." part."""
...
Answer:"""
    ...
    def test_roleplay_naturalness(self):
        """Test if Phi-2 acts like the character or spews information."""
...
Respond as Kael Vire:"""
    ...
    def test_rag_compatibility(self):
        """Test if Phi-2 responds logically to external context."""
...
Respond as Kael Vire:"""
    ...
    def generate_report(self):
        ...
        print("\n" + "="*80)
        print("PHI-2 MODEL EVALUATION REPORT")
        print("="*80)
...
def main():
    print("Starting Phi-2 Model Evaluation...")
